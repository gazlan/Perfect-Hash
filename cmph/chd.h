...
/** \fn void chd_config_set_keys_per_bin(cmph_config_t *mph, DWORD keys_per_bin);
...
/** \fn void chd_config_set_b(cmph_config_t *mph, DWORD keys_per_bucket);
...
/** \fn DWORD chd_packed_size(cmph_t *mphf);
...
/** DWORD chd_search(void *packed_mphf, const char *key, DWORD keylen);
