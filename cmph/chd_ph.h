...
/** \fn void chd_ph_config_set_keys_per_bin(cmph_config_t *mph, DWORD keys_per_bin);
...
/** \fn void chd_ph_config_set_b(cmph_config_t *mph, DWORD keys_per_bucket);
...
/** \fn DWORD chd_ph_packed_size(cmph_t *mphf);
...
/** DWORD chd_ph_search(void *packed_mphf, const char *key, DWORD keylen);
